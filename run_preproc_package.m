...
function run_preproc_package(varargin)
    ...
    if (length(varargin) ~= 5)
           fprintf(['There is a problem with your input!\n',...
               'Input is: run_preproc_package("TEXTFILENAME.txt","JOB_FILE", "DIRECTORY_PREFIX", "TASK_FOLDER", "TYPE")\n',...
    ...
    for i=1:size(C{1})
	    ...
	    spm_jobman('run', matlabbatch);
            fprintf('Deleting extra files.\n');
            for i = 1:runs
                delete([subjectDir,taskDir,'run',num2str(i),'/rf*']);
                delete([subjectDir,taskDir,'run',num2str(i),'/wrf*']);
            end
